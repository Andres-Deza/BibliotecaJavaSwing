...
public class PanelEditorial extends javax.swing.JPanel {
    ...
    public PanelEditorial() {
        ...
        BDEditorial.listar(tableTablaDatos);
        comprobarCampos();
    ...
    public void comprobarCampos(){
        String cc = txtNumRut.getText() + txtDigRut.getText().isEmpty() + txtNombre.getText() + txtDireccion.getText() + txtTelefono.getText() + txtCorreo.getText();
        if ( cc.equals("")){
    ...
    public void obtenerCampos(){
        ...
        txtCorreo.setText(String.valueOf(tableTablaDatos.getValueAt(rowSel, 5)));
    }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try{            
            ...
            if(btnAgregar.isSelected()){
                BDEditorial.insertar(rut, nom, dir, tel, cor);
                BDEditorial.listar(tableTablaDatos);
                Limpiar.contenidoPanel(panelCampos);
                comprobarCampos();
            }else if(btnModificar.isSelected()){
                int id = Integer.parseInt(lblID.getText());
                BDEditorial.modificar(id, rut, nom, dir, tel, cor);
                BDEditorial.listar(tableTablaDatos);
                Limpiar.contenidoPanel(panelCampos);
                comprobarCampos();
            }
    ...
    private void btnFiltrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFiltrarActionPerformed
        ...
        if (criterioBusqueda.equals("Rut")){
            BDEditorial.filtrar(tableTablaDatos, "rut_editorial", textoBusqueda);
        }else if (criterioBusqueda.equals("Nombre")){
            BDEditorial.filtrar(tableTablaDatos, "nombre_editorial", textoBusqueda);
        }
